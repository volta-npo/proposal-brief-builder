export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Evidence-Backed Proposal Builder",
        "Operational table: Proposal claims",
    ...
    "releaseChecklist": [
        ...
        "Evidence Confidence reaches production threshold",
        "Narrative Completeness is documented with evidence",
        "Budget Alignment has no unresolved blocker",
        "Proposal outline verified",
        "Writer handoff packet verified",
        "Evidence appendix CSV verified"
    ],
    "operations": [
