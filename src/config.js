  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify problem statement canvas with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify program facts table with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-lockbox",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify evidence lockbox with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify drafting handoff packet with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
