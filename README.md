...
### Turn messy discovery notes into a clean grant proposal brief before anyone writes prose.
...
**Finance & Grants** · **Repo 13/50** · **No backend. No login. Client data stays local.**
...
**Proposal Brief Builder** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Students who need to write with clarity and avoid hallucinated claims turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Grant writing fails when teams start drafting before facts, outcomes, budget, and eligibility are aligned.

### The niche

Responsible grant writing for small nonprofits.

### North-star metric

`proposal sections supported by verified facts`
...
flowchart TD
    ...
    Evidence --> Workbench["Proposal Brief Builder"]
    Workbench --> Score["Funding readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["Proposal outline"]
    Cert --> A2["Writer handoff packet"]
    Cert --> A3["Evidence appendix CSV"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Problem statement canvas"]
        M2["Program facts table"]
        M3["Evidence lockbox"]
        M4["Drafting handoff packet"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Proposal Brief Builder
...
|---|---|
| **Domain workbench** | A purpose-built brief builder interface for turn messy discovery notes into a clean grant proposal brief before anyone writes prose. |
...
|---:|---|---|
| 1 | **Problem statement canvas** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Program facts table** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Evidence lockbox** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Drafting handoff packet** | Converts field work into repeatable, reviewable Volta delivery evidence. |
